...
function getStyledAvailabilities(_ref8) {
  ...
  var isManagingWidth = rightOffset !== undefined;
  ...
  clusters.forEach(function (cluster) {
    ...
    cluster.forEach(function (availability) {
      var placed = false;
    ...
    var nbrOfColumns = Object.keys(availabilitiesByColumn).length;
    var width = isManagingWidth ? (100 - rightOffset) / nbrOfColumns : undefined;

    Object.entries(availabilitiesByColumn).forEach(function (_ref9) {
      var columnIndexKey = _ref9[0],
          group = _ref9[1];
      ...
      group.forEach(function (availability) {
        ...
        var xOffset = isManagingWidth ? width * Number(columnIndexKey) : columnIndexKey * 20;
        styledAvailabilities.push({
          availability: availability,
          style: _extends({
            height: height,
            top: top
          }, isManagingWidth ? { width: width } : {}, {
            xOffset: xOffset
          })
        });
      });
