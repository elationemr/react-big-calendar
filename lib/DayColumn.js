...
var DaySlot = function (_React$Component) {
  ...
  DaySlot.prototype.render = function render() {
    var _props = this.props,
        ...
        props = _objectWithoutProperties(_props, ['min', 'max', 'date', 'step', 'now', 'nowTimezone', 'selectRangeFormat', 'culture', 'isMultiGrid']);
    ...
    return _react2.default.createElement(
      ...
      _extends({}, props, {
        className: (0, _classnames2.default)('rbc-day-slot', !isMultiGrid && _dates2.default.isToday(date, nowTimezone) && 'rbc-today', _dates2.default.lt(date, _dates2.default.today(nowTimezone), 'day') && 'rbc-past', (_bowser2.default.mobile || _bowser2.default.tablet) && 'rbc-mobile-clickable'),
        now: now,
...
DaySlot.propTypes = {
  ...
  availabilityRightOffset: _propTypes2.default.number,
...
DaySlot.defaultProps = { dragThroughEvents: true, rightOffset: 0, availabilityRightOffset: 0, isMultiGrid: false };
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.renderAvailabilities = function () {
    var _props2 = _this2.props,
        ...
        availabilityRightOffset = _props2.availabilityRightOffset,
        min = _props2.min,
  ...
  this.renderEvents = function () {
    ...
    var effectiveMax = _dates2.default.min(max, _dates2.default.endOf(date, 'day'));
    ...
    return styledEvents.map(function (_ref2, idx) {
      ...
      var continuesAfter = startsAfter(end, effectiveMax);
  ...
  this._selectable = function () {
    ...
    var selectionState = function selectionState(_ref3) {
      ...
      var currentMinutes = mins * current;
      ...
      if (_this2.state.selecting) currentMinutes += step / 2;
