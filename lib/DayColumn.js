...
DaySlot.propTypes = {
  ...
  onAvailabilityClick: _propTypes2.default.func.isRequired,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.renderAvailabilities = function () {
    ...
    return styledAvailabilities.map(function (_ref, idx) {
      ...
      var height = style.height,
          isMultiColumn = style.isMultiColumn,
          top = style.top,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          {
            className: (0, _classnames2.default)('rbc-availability', isMultiColumn && 'rbc-availability-overlap'),
            style: {
              top: top + '%',
              height: height + '%',
              left: xOffset
            ...
            onClick: function onClick(e) {
              return _this2._onAvailabilityClick(availability, e);
            }
          },
          _react2.default.createElement(
            'div',
            { className: 'rbc-availability-content' },
            AvailabilityComponent && _react2.default.createElement(AvailabilityComponent, { availability: availability, isMultiColumn: isMultiColumn })
          )
        )
      );
    });
  ...
  this._onAvailabilityClick = function () {
    for (var _len3 = arguments.length, args = Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
      args[_key3] = arguments[_key3];
    }

    (0, _helpers.notify)(_this2.props.onAvailabilityClick, args);
  };
};
