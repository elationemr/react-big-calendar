...
var MultiTimeGrid = function (_Component) {
  ...
  MultiTimeGrid.prototype.renderEventsAndAvailabilities = function renderEventsAndAvailabilities(date, rangeEventsMap /* , today */) {
    var _this3 = this;
    ...
    var _props3 = this.props,
        ...
        availabilityMap = _props3.availabilityMap,
        availabilityStartAccessor = _props3.availabilityStartAccessor,
        availabilityEndAccessor = _props3.availabilityEndAccessor;


    return this.props.selectedEntityKeys.slice(0, this.slots).map(function (selectedEntityKey, idx) {
