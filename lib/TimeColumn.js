...
var TimeColumn = function (_Component) {
  ...
  function TimeColumn() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.rootRef = function (div) {
      ...
      var dayStart = _dates2.default.startOf(now, 'day');
      var dayEnd = _dates2.default.endOf(now, 'day');

      var dayStartTimezoneOffset = dayStart.getTimezoneOffset();
      ...
      var isAfterFallBackTimeShift = dayStartTimezoneOffset < dayEndTimezoneOffset && nowTimezoneOffset === dayEndTimezoneOffset;
