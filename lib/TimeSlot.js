...
var TimeSlot = function (_Component) {
  ...
  TimeSlot.prototype.render = function render() {
    ...
    var availableClassName = void 0;
    var availableStyle = void 0;
    if (slotPropGetter) {
      var _ref = slotPropGetter(value, entityKey, isMultiGrid) || {},
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        {
          className: (0, _classnames2.default)('rbc-time-slot', this.props.showLabel && 'rbc-label', !this.props.showLabel && availableClassName, this.props.isNow && 'rbc-now'),
          style: _extends({}, !this.props.showLabel ? availableStyle : {})
        },
